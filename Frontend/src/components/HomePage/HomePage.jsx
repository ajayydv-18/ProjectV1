      ...
      <div className="banner mt-15 ">
        <div className="slider" style={{ "--quantity": 10 }}>
          ...
          <div className="item" style={{ "--position": 5 }}>
            <img
              src="https://images.unsplash.com/photo-1505664063603-28e48ca204eb"
              alt="Law documents"
            />
          </div>
          ...
          <div className="item" style={{ "--position": 8 }}>
            <img
              src="https://images.unsplash.com/photo-1581091870627-3a4a3c1f1bfa"
              alt="Law office"
            />
          </div>
        ...
        <h1 className="text-9xl text-[#031b38] font-bold absolute top-[40%] left-[20%]">LEX <span className="text-[#dbaa2f]">BRIDGE</span></h1>
